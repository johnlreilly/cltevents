        ...
        return (
          <Fragment key={event.id}>
            {showDateSeparator && currentDate && (
              <div
                id={dateId}
                className="md:col-span-2 bg-[#1E3A5F] rounded-3xl h-32 flex flex-col justify-end items-start text-white sticky top-[46px] z-20 overflow-hidden relative px-4 pb-3"
              >
